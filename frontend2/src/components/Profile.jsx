...
const skills=["HTML" ,"JAVA" ,"CPP" ,"PYTHON"]
    ...
    <div>
        ...
        <div className='max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8'>
            ...
            <div className='grid w-full max-w-sm items-center gap-1.5'>
                ...
                {
                    user?.profile?.resume ? <a target='_blank' href={`${USER_API_END_POINT}/resume/view`} className='text-blue-500 w-full hover:underline cursor-pointer'>{user?.profile?.resumeOriginalName}</a> : <span>NA</span>
                }
            </div>
        ...
        <div className='max-w-4xl mx-auto bg-white rounded-2xl'>
            ...
            {/* kon kon se jobs ko applied kiya hua hia apne */}
            <AppliedJobTable/>
        </div>
